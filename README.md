...
<p align="center">
  <img src="Hotel Booking Analysis Dashboard.png" alt="Hotel Booking Analysis Dashboard" width="100%">
</p>
...
```md
![Hotel Booking Dashboard](Hotel Booking Analysis Dashboard.png)
```
